...
b1 = "https://ndb.nal.usda.gov/ndb/search/list?format=&count=&max=50&sort="
b2 = "fd_s&fgcd=&manu=&lfacet=&qlookup=&ds=&qt=&qp=&qa=&qn=&q=&ing=&offset="
b3 = "&order=asc"
...
def update_timer(ix, n):
    elapsed = time.time() - t0
    avg_sp = elapsed / ix + 1
    est_rem = ((n - ix + 1) * avg_sp)
...
all_df_s = lmap(get_dfs, urls_s)

t0 = time.time()

all_df_b = lmap(get_dfs, urls_b)
